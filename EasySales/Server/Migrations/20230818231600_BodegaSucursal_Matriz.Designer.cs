...
namespace EasySales.Server.Migrations
{
    ...
    [Migration("20230818231600_BodegaSucursal_Matriz")]
    partial class BodegaSucursal_Matriz
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasySales.Shared.Bodegas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasySales.Shared.CantidadInventarioMatriz", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("CantidadInventarioMatriz");
                });
            ...
            modelBuilder.Entity("EasySales.Shared.EstadoReserva", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasySales.Shared.Inventario.BodegaSucursalMatriz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BodegaSucursalMatriz");
                });
            ...
            modelBuilder.Entity("EasySales.Shared.Reservaciones", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("MontoReservacion")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("EasySales.Shared.FacturaDetalle", b =>
                {
                    b.HasOne("EasySales.Shared.Productos", "Producto")
                        .WithMany()
            ...
            modelBuilder.Entity("EasySales.Shared.Inventario.BodegaSucursalMatriz", b =>
                {
                    b.HasOne("EasySales.Shared.Bodegas", "Bodega")
                        .WithMany()
            ...
            modelBuilder.Entity("EasySales.Shared.Reservaciones", b =>
                {
                    ...
                    b.HasOne("EasySales.Shared.EstadoReserva", "EstadoReserva")
                        .WithMany()
